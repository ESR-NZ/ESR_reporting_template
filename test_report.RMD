...
date: "Date: `r format(Sys.time(), '%d/%m/%Y')`"        # grabs current date
always_allow_html: true
output:
  bookdown::html_document2:
    toc: true                                           # create a table of contents
    toc_depth: 2                                        # set the table of contents depth
    number_sections: false                              # choose whether or not to number sections
    toc_float: true
    self_contained: yes
    css: esr-styles.css
    highlight: pygments
...
```{r ggtree, echo=F, fig.cap="Caption can go here if needed.", fig.topcaption=TRUE, fig.align="center"}
